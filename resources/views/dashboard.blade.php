        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- Tampilkan ringkasan hanya untuk Staff atau Kepala Perpustakaan --}}
                    ...
                    @else
                    {{-- Tampilan Dashboard untuk Anggota --}}
                    <h3 class="text-xl font-semibold mt-8 mb-6">Selamat Datang, {{ Auth::user()->nama }}!</h3>
                    <p class="text-gray-700">Anda dapat menjelajahi katalog buku, melihat riwayat peminjaman, dan mengecek denda Anda.</p>
                    <div class="mt-4">
                        ...
                        <a href="{{ route('peminjaman.my_history') }}" class="ms-3 inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
